...
export class GoalsYearly extends React.Component {
	constructor() {
		super();
		this.state = {
			todo: "",
				...
				{({ store, actions }) => (
					<>
						<div className="container">
							...
							<h5 className="text-center mt-3">2020 GOALS</h5>
							...
							{store.goalsyearly &&
								store.goalsyearly.map((todo, index) => (
									<div key={index} className="d-flex">
										<div className="d-flex justify-content-around mx-auto col-lg-6">
											<textarea
												...
												onChange={e => actions.handleChangeGoalsYearly(e, index)}
											/>
											<span
												onClick={() => actions.deleteGoalsYearly(index)}
