...
export class WorkQuarterly extends React.Component {
	constructor() {
		super();
		this.state = {
			todo: "",
			...
			<Context.Consumer>
				{({ actions, store }) => (
					<div className="container">
						...
						<h5 className="text-center mt-3">QUARTERLY WORK LIST</h5>
						...
						{store.workquarterly &&
							store.workquarterly.map((todo, index) => (
								<div key={index} className="d-flex">
									<div className="d-flex justify-content-around mx-auto col-lg-6">
										<textarea
											...
											onChange={e => actions.handleChangeWorkQuarterly(e, index)}
										/>
										<span
											onClick={() => actions.deleteWorkQuarterly(index)}
